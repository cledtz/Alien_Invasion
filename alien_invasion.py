...
def run_game():
    ...
    while True:
        ...
        gf.check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, missiles)
        ...
        if stats.game_active:
            ...
            gf.check_alien_ship_collisions(ai_settings, screen, stats, sb, ship,
                                           aliens, missiles, bullets)
